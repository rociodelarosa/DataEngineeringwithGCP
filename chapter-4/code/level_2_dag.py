...
GCP_PROJECT_ID = 'rocio-packt-gcp-data-eng'
INSTANCE_NAME = 'mysql-instance'
EXPORT_URI = 'gs://rocio-packt-gcp-data-eng-data-bucket/mysql_export/from_composer/stations/stations.csv'
...
with DAG(
    ...
    bucket                              = 'rocio-packt-gcp-data-eng-data-bucket',
